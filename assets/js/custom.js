!function(e) {
    ...
    async function t(t) {
        ...
        t || (window.$effectScroll = await function() {
            ...
            return {
                ...
                isScroller: function(e) {
                    ...
                    return t && e && $body.addClass("dsn-mobile"),
                    !t
                },
                locked: function() {
                    if ($body.addClass("locked-scroll"),
                    this.isScroller()) {
                ...
                getListener: function(e, t=!0) {
                    if (void 0 === e)
                        return;
                    let n = this;
                    n.isScroller() ? n.getScrollbar().addListener(e) : t && $wind.on("scroll", e),
                    n = null
                },
            ...
            return {
                ...
                nextProject: function() {
                    ...
                    l.on("progress", (function(e) {
                        t.find(".case .number").text((100 * e.progress).toFixed(0) + "%"),
                        i.css({
                ...
                tweenImage: function(e, n) {
                    ...
                    if (e.attr("data-dsn-grid", "moveUp"),
                    i.length > 0) {
                ...
                animateText: function(t, n) {
                    n.length && n.each((function() {
                        ...
                        t.gsap.staggerFrom(e(this).find(".dsn-word-wrapper"), .6, {
                ...
                animateLine: function(e, t) {
                    ...
                    e.$this.find(".line.line-top").length && e.gsap.from(e.$this.find(".line.line-top").toArray(), 1, {
                        scaleX: 0,
                        transformOrigin: "right"
                    }, "line"),
                    e.$this.find(".line.line-left").length && e.gsap.from(e.$this.find(".line.line-left").toArray(), 1, {
                        scaleY: 0,
                        transformOrigin: "top"
                    }, "line+=1"),
                    e.$this.find(".line.line-bottom").length && e.gsap.from(e.$this.find(".line.line-bottom").toArray(), 1, {
                        scaleX: 0,
                        transformOrigin: "left"
                    }, "line+=2"),
                    e.$this.find(".line.line-right").length && e.gsap.from(e.$this.find(".line.line-right").toArray(), 1, {
                        scaleY: 0,
                ...
                tweenMoveSection: function(n) {
                    ...
                    "tablet" === dsnGrid.getData(this, "responsive") && dsnGrid.isMobile() || n.to(i, 1, {
                ...
                parallaxImgHover: function() {
                    dsnGrid.isMobile() || e('[data-dsn="parallax"]').each((function() {
                        ...
                        dsnGrid.parallaxMoveElement(t, dsnGrid.getData(t, "move", 20), dsnGrid.getData(t, "speed", .5), t.find(".dsn-parallax-rev").get(0), t.hasClass("image-zoom")),
                        t = null
                    }
                    ))
                },
                dsnScrollTop: function() {
                    const t = e(".wrapper");
                    if (!t.length || !e(".scroll-to-top").length)
                        return;
                ...
                translateSection: function() {
                    e(".section-image.section-move-image .transform-move-section").each((function() {
                        ...
                        e(this).append(e(this).find(".swiper-slide").clone()),
                        n -= e(this).width(),
                        e(this).hasClass("move-left") ? t.to(this, {
                            x: -1 * n
                        }) : t.from(this, {
                            x: -1 * n
                        });
            ...
            return {
                    ...
                    return new Swiper(t.find(".slide-inner").get(0),{
                        ...
                        pagination: {
                            ...
                            renderCustom: function(e, n, i) {
                                return t.find(".slider-total-index").html(dsnGrid.numberText(i)),
                        ...
                        on: {
                            ...
                            touchStart: function() {
                                ...
                                !dsnGrid.isMobile() && $body.hasClass("dsn-cursor-effect") && (e(this.slides).parents(".main-slider").hasClass("has-horizontal") ? e(".cursor").addClass("cursor-scale-half cursor-drag cursor-next cursor-prev") : e(".cursor").addClass("cursor-scale-half cursor-up-down cursor-drag cursor-next cursor-prev"))
                            },
                            touchEnd: function() {
                ...
                slideChange: function(t, i, a) {
                    ...
                    t.on("slideChange", (async function() {
                        ...
                        n.progress(1),
                        n = new gsap.timeline,
                        n.staggerFromTo(p ? f.toArray().reverse() : f, .3, s.showText(a).title, s.hideText(p, a).title, .05, 0, (function() {
                            i.find(".dsn-slider-content .slide-content").removeClass("dsn-active").removeClass("dsn-active-cat"),
                            h.addClass("dsn-active"),
                            h.addClass("dsn-active-cat")
                        }
                        )),
                        n.staggerFromTo(p ? u.toArray().reverse() : u, .8, s.hideText(!p, a).title, s.showText(a).title, .05, "-=.1"),
                ...
                slideChangeWeb: function(e, t, i, a, s) {
                    ...
                    n.progress(1),
                    n = new gsap.timeline,
                    n.staggerFromTo(s ? o.toArray().reverse() : o, .3, this.showText(t).title, this.hideText(s, t).title, .05, 0, (function() {
                        e.find(".dsn-slider-content .slide-content").removeClass("dsn-active").removeClass("dsn-active-cat"),
            ...
            class e {
                ...
                initEvents() {
                    this.positionElement = e=>{
                        ...
                        a = 0,
                        (n = e) || (n = window.event),
                        n.pageX || n.pageY ? (i = n.pageX,
                        a = n.pageY) : (n.clientX || n.clientY) && (i = n.clientX + document.body.scrollLeft + document.documentElement.scrollLeft,
                        a = n.clientY + document.body.scrollTop + document.documentElement.scrollTop),
                        {
                            x: i,
                            y: a
                        });
                        ...
                        if ($effectScroll.isScroller()) {
                            ...
                            this.DOM.reveal.style.top = t.y - this.DOM.reveal.offsetHeight / 2 + e.offset.y + "px",
                            this.DOM.reveal.style.left = t.x - (this.DOM.reveal.offsetHeight / 2 - 60) - e.offset.x + "px"
                        } else {
                            const e = {
                ...
                animateLetters() {
                    ...
                    this.DOM.letters.forEach(e=>TweenMax.set(e, {
        ...
        void (window.location.hash.length && ($wind.scrollTop(0),
            ...
            ajaxLoad: function() {
                ...
                this.ajaxClick.on("click", (function(n) {
                    ...
                    let i = e(this)
                      , s = i.attr("href")
                      , o = i.data("dsn-ajax");
                    s.indexOf("#") >= 0 || void 0 === s ? i = s = o = null : t.effectAjax() || (t.effectAjax(!0),
                    e.ajax({
                        url: s,
                        dataType: "html",
                        ...
                        success: function(e) {
                            try {
                                ...
                                a.call(t.animateAjaxEnd.bind(t, e), null, null, "+=0.2")
                            } catch (e) {
                                window.location = s
                            }
                        },
